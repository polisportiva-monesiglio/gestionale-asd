            ...
            <div className={`animate-fade-in ${step === 3 ? 'block' : 'hidden'}`}>
              ...
              <div className="space-y-4 mb-10">
                ...
                <label className="flex items-start cursor-pointer group p-4 bg-gray-50 hover:bg-yellow-50/50 rounded-xl transition-colors border border-gray-200 hover:border-yellow-400 shadow-sm">
                  ...
                  <span className="ml-3.5 text-sm text-gray-600 leading-relaxed font-medium"><strong className="text-gray-900 font-bold block mb-0.5">Certificato medico e dati sulla salute</strong> Acconsento al trattamento del certificato medico e dei dati sulla salute che contiene, per la sola verifica dell'idoneità alla pratica sportiva non agonistica. Senza questo consenso non è possibile tesserarsi, perché senza certificato non è consentito svolgere attività sportiva. Puoi revocarlo quando vuoi scrivendo alla segreteria: in quel caso cancelliamo il certificato e non potrai più allenarti finché non ne consegni uno nuovo.</span>
                </label>
